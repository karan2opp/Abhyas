...
9. QUESTION VARIETY & INTENT: By default, you MUST generate a diverse mix of question styles (conceptual, definition, application, code-tracing). Do NOT just generate "What is the output of this code?" questions unless specifically asked.
10. INTERPRETING TEACHER INSTRUCTIONS: Teachers may give simple instructions like "normal", "theory", or "conceptual". If you see these, you MUST explicitly AVOID code snippets and output-prediction questions, focusing entirely on theoretical knowledge. Conversely, if they ask for "prediction" or "code output", focus heavily on code execution tracing.

...
// code listing, a table, or a list. See question.schema.ts's
// QuestionContentBlock, which this must stay structurally compatible with
// (it's what these questions get stored as once saved). Kept intentionally
// small — no html type, see that file's comment for why.
...
const QuestionContentBlockZodSchema = z.discriminatedUnion("type", [

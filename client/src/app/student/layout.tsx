...
import { GraduationCap, LayoutDashboard, History, LogOut, ChevronsLeft, ChevronsRight, Menu, X, User, School } from "lucide-react";
...
const sidebarLinks = [
  ...
  { name: "Classrooms", href: "/student/classrooms", icon: School },
            ...
            <div className={cn("p-6 flex items-center gap-3", isCollapsed ? "justify-center p-4" : "")}>
              ...
              {!isCollapsed && (
                <div className="overflow-hidden whitespace-nowrap">
                  ...
                  <p className="text-[11px] text-gray-400 font-medium tracking-wide uppercase">Student Portal</p>
                </div>
              )}
            </div>

...
6.
7. The "reference_examples" field contains previous questions , you can take refernce from it. 
8. Dont over complicate any question and no over explanation in the question.
9. Respond with structured output only, following the question format and structure shown in the reference_examples.
`;
};

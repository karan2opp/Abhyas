...
import { ArrowLeft, Settings, KeyRound, Users, UserPlus, Layers, ClipboardList, FileText } from "lucide-react";
          ...
          <div className="p-4 border-b border-white/5">
            ...
            <Link
              ...
              className={`flex items-center gap-1.5 text-sm mt-1.5 transition-colors ${
                pathname === `/teacher/classrooms/${classroomId}/settings` ? "text-blue-400" : "text-gray-500 hover:text-blue-400"
              }`}
            >
